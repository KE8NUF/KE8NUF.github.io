...
// toggleColons() //  * * * * * * * * * * add back in from scrap.js, or make a better one  * * * * * * *
 ...
 // saySomething(":-(") //  * * * * * * * * * * add back in from scrap.js, or make a better one  * * * * * * *
    ...
    function switchOn( tube, di) {  
		...
		$(tube).find('.base_glow_two').addClass("base_glow_effect_two");		 
    }
    ...
    function switchOff( tube, di) { 
      ...
      if (typeof di === 'undefined' || di === null ){ 
        ...
        $('.base_glow').removeClass("base_glow_effect");
			$('.base_glow_two').removeClass("base_glow_effect_two");
			  ...
			  $(tube).find('.base_glow_two').removeClass("base_glow_effect_two");
              } 
    }; 
    ...
    function switchOnOff( tube, di) { 
	  ...
	  $(tube+' .base_glow_two').removeClass("base_glow_effect_two");
      if ( di == '' || di == ' ' ){ 
...
$(".nixie_container").mouseleave(function() {
	humOne.pause();
	humOne.currentTime = 0;
}); 
